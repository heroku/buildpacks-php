...
#[rustfmt::skip]
pub(crate) const PLATFORM_REPOSITORY_SNAPSHOT: &str = "0c4b400977963e9157e702fe928ddd757c8e0a721c9bfe8dc7aebea41df32965";
const PHP_VERSION: &str = "8.3.24";
const COMPOSER_VERSION: &str = "2.8.10";
