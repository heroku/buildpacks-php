...
#[rustfmt::skip]
pub(crate) const PLATFORM_REPOSITORY_SNAPSHOT: &str = "81e3a36badfa0b3ae86067c980b35231ec94c303f3fd9fd2a36e7995db1a475d";
const PHP_VERSION: &str = "8.3.25";
const COMPOSER_VERSION: &str = "2.8.11";
