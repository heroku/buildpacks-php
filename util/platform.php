...
$plugin_path = array_shift($argv);
$repositories = [
	["packagist" => false],
	["type" => "path", "url" => $plugin_path, "options" => ["symlink" => false]],
	["type" => "path", "url" => realpath($plugin_path."/../.."), "options" => ["symlink" => false, "versions" => ["heroku/heroku-buildpack-php" => "dev-master"]]],
];
...
$require["heroku/heroku-buildpack-php"] = "dev-master";
